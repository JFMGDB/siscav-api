# Milestone archive: v1.0 — API brownfield hardening

**Status:** SHIPPED 2026-04-05  
**Phases:** 1–4 (11 planos)  
**Nota:** Copia histórica do ROADMAP antes do fecho do milestone; ligações `phases/...` são relativas a `.planning/`.
