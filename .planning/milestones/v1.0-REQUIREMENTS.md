# Requirements Archive: v1.0 API brownfield hardening

**Archived:** 2026-04-05
**Status:** SHIPPED

Para o ciclo seguinte, criar `.planning/REQUIREMENTS.md` com **`/gsd-new-milestone`** (este ficheiro é só arquivo v1.0).
