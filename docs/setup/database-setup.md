...
## SQLite local / desenvolvimento (primeiro arranque)
...
1. **Criar usuário administrador**: Execute `python scripts/seed_demo.py` na raiz do repositório (ver docstring em `scripts/seed_demo.py`) ou crie manualmente
