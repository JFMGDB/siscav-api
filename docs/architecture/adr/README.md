...
- [011 — Ambulance Auto-Authorization Policy (ONNX Runtime)](./011-ambulance-auto-authorization-policy.md) — ONNX classifier on ingest, ephemeral `vehicle_classification`, cold-start mitigations
